\section{Rechenregeln der Laplace Transformation}
...
Sei $f$ auf $[0, \infty[$ mindestens differenzierbar, wobei die Ableitung $f'$ auf jedem endlichen Intervall nur endlich viele Sprungstellen besitzt (also stückweise stetig ist). Alternativ kann $f$ auch stetig differenzierbar auf $[0, \infty[$ sein, dann kann folgende Rechenregel angewendet werden /cite{buch1}:
