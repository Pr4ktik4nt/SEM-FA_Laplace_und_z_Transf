...
Über die Definition der Potenzreihe lässt sich auch noch ein weiterer Ansatz zur Rücktransformation formulieren. Dabei kann das k-te Element der Urbildfolge $x[k]$ über die k-te \textbf{Ableitung} der Bildfunktion an der Stelle $\frac{1}{z}$ bestimmt werden:
