...
Damit eine komplexe Funktion $f(z)$ differenzierbar ist, müssen die Cauchy-Riemann-Gleichungen erfüllt sein.
Hierzu wird die Variable $z = x +jy$ und $f(z) = u(x,y) + j \cdot v(x,y)$ in ihre Real- und Imaginärteile zerlegt.
...
\begin{equation}
    f'(z) = \frac{\partial u}{\partial x} + j\cdot \frac{\partial v}{\partial x} = \frac{\partial v}{\partial y} - j\cdot \frac{\partial u}{\partial y}
\end{equation}
...
\begin{equation}
    (x_1 * x_2)[k] = \sum_{n=-\infty}^{\infty} x_1[n] \cdot x_2[k-n]
\end{equation}
