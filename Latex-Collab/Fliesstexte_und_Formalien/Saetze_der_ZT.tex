\subsection{Sätze der z-Transformation}
...
Für eine rechtsseitige Folge, wie sie bei Abtastwerten vorliegt, also bei der $x[k] = 0$ für $k<0$ gilt, ist laut dem Anfangswertsatz der Wert zum Zeitpunkt $k=0$ \cite[S.215]{book3}:
\begin{equation}
