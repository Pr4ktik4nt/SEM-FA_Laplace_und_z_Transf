...
Die betrachtete Funktion ist außerdem kausal, nimmt also nur für Werte von t ab dem Zeitpunkt $t=0$ Funktionswerte an. Es gilt: $x(t) = 0$ für $t<0$. Demnach beschränken wir uns im Folgenden auf die einseitige z-Transformation.
