...
Die z-Transformation ist eine diskrete Variante der Laplace-Transformation. Sie erlaubt im Gegensatz zur DFT auch die Analyse von instabilen Systemen. Sie findet Anwendunng in der Analyse zeitdiskreter Signale und Systeme \cite[S.231]{book2}. (+Zitiert aus Gref SIG Vorlesung)
